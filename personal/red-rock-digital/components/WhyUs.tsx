const differentiators = [
  {
    title: "Your site. Your domain. Your code.",
    description:
      "You own your domain, your content, and your code — always. We run the hosting, the updates, and the infrastructure, so you're never left holding a server you don't understand or a bill you didn't expect. If something breaks, it's our problem to fix.",
    icon: (
  ...
  },
  {
    ...
    description:
      "We connect your Google Business Profile to your site and pull in your latest reviews automatically. You decide which real reviews to feature from a simple dashboard — no copy-pasting, no fakes. Your reputation builds itself.",
    icon: (
      <svg className="w-6 h-6" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description:
      "We earn your business every month. Cancel anytime with 30 days notice — no penalties, no lock-in. If you ever decide to leave, we'll help you migrate your site and hand over everything.",
    icon: (
      <svg className="w-6 h-6" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
